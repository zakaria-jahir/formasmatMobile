...
export default function FormationsScreen() {
  ...
  useEffect(() => {
    axios
      .get("http://172.20.10.11:5000/api/formations/")
      .then((res) => {
        setAllFormations(res.data);
        return axios.get("http://172.20.10.11:5000/api/my-wishes/", {
  ...
  const toggleWish = (formationId: number) => {
    ...
    const url = isWished
      ? "http://172.20.10.11:5000/api/remove-wish/"
      : "http://172.20.10.11:5000/api/add-wish/";
